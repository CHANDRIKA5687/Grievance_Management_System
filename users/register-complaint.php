...
{ 
    ...
    if(isset($_POST['submit']))
    {
        ...
        $query = mysqli_query($bd, "INSERT INTO tblcomplaints (complaintNumber, userId, category, subcategory, complaintType, state, noc, complaintDetails, complaintFile, regDate, status, lastUpdationDate)
        VALUES ('$complainno', '$uid', '$category', '$subcat', '$complaintype', '$state', '$noc', '$complaintdetails', '$compfile', current_timestamp(), NULL, '0000-00-00 00:00:00')");
